// src/data/fluxosAssistenciaisData.js

export const fluxosAssistenciaisData = {
  title: 'Fluxos Assistenciais e Pactuações do SUS',
  desc: 'Consulte os fluxogramas de atendimento, protocolos de regulação e encaminhamentos da rede pública de saúde de Muriaé.',
  fluxosData: [
    {
      id: 'cardiologia',
      titulo: 'Cardiologia',
      ...
      submodulos: [
        {
          ...
          imagens: [
            { src: '/img/fluxos-assistenciais/oncologia/fluxo1.png', alt: 'Fluxo Oncologia' }
          ]
        }
      ]
    },
