...
export const tiposVacinas = [
  {
    ...
    proceder:
      "Comparecer a uma UBS portando a caderneta para avaliação do profissional.",
  ...
  },
  {
    ...
    proceder:
      "Lavar o ferimento com água e sabão e procurar atendimento imediatamente.",
  ...
  },
  {
    ...
    proceder:
      "Faixa etária convocada (10 a 14 anos) deve comparecer acompanhada dos pais.",
      ...
      <section className={styles.heroBanner}>
        <div className={styles.container}>
          ...
          <p className={styles.heroDesc}>
            Imunização gratuita e segura para todas as faixas etárias, conforme
            as diretrizes do Programa Nacional de Imunizações (PNI).
          </p>
        </div>
      </section>
      ...
      <main className={styles.mainContent}>
        <div className={styles.container}>
          ...
          <div className={styles.infoBlock}>
            <h2>
              <Syringe size={22} color="#005c8a" /> Programa Nacional de
              Imunizações (PNI)
            </h2>
            <p>{servico.desc}</p>
            <p>
              As vacinas estão disponíveis nas Salas de Vacina das Unidades
              Básicas de Saúde (UBS). Para vacinar, basta comparecer com
              documento de identificação, Cartão SUS e a Caderneta de Vacinação.
            </p>
          </div>

          {/* BANNER EM DESTAQUE - CALENDÁRIO VACINAL (MUITO MAIS NÍTIDO) */}
          <div className={styles.calendarBannerCard}>
            <div className={styles.calendarBannerContent}>
              <div className={styles.calendarBannerBadge}>
                <Calendar size={16} /> Consulta Oficial
              </div>
              <h3>Calendário Nacional de Vacinação</h3>
              <p>
                Confira o cronograma completo de doses e faixas etárias recomendadas pelo SUS para crianças, adolescentes, adultos e idosos.
              </p>
            </div>
            <Link href="/calendario-vacinal" className={styles.calendarBannerBtn}>
              Acessar Calendário <ArrowRight size={18} />
            </Link>
          </div>
